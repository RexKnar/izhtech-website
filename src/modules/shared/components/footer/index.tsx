...
const Footer: FC = () => {
  return (
    <footer className="bg-dark text-inverse">
      <div className="container pt-1 pt-md-1 pb-13 pb-md-15">
        ...
        <div className="row gy-6 gy-lg-0">
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              ...
              <p className="mb-4">
                © 2023 IZH-Tech. <br className="d-none d-lg-block" />
                All rights reserved.
              </p>
          ...
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              ...
              <NextLink title="info@izhtech.com" href="mailto:info@izhtech.com" />
              <br /> 00 (123) 456 78 90
            </div>
          </div>
                    ...
                    <div id="mc_embed_signup_scroll2">
                      <div className="mc-field-group input-group form-floating">
                        ...
                        <input
                          ...
                          className="btn text-white gradient-5"
                        />
                      </div>
